...
parser.add_argument('--trade_period_start', action="store", dest="trade_period_start",  default='201001', help='Give the start date of the trade period to download in YYYYMM format.')
parser.add_argument('--trade_period_end', action="store", dest="trade_period_end",  default='201306', help='Give the end date of the trade period to download in YYYYMM format.')
