...
```{r}
filename <- '012008-122017_870331_870332_870333.RData'
load(filename)
```

```{r}
# Look up commodity descriptions related to "halibut"
ct_commodity_lookup("mushrooms",return_code = FALSE,return_char = FALSE,verbose = TRUE)
```
...
```{r}
sel_country <- c("Germany")
sel_trade <- "Exports"
```

```{r}
cc <- cc %>% filter(commodity_code == "870331")
```
