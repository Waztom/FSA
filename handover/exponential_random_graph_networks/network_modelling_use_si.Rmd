...
knitr::opts_knit$set(root.dir = "~/Projects/FSA/models/Animal_trade/animal_trade_paper")
```
...
#Remove grouped areas
ignore <- list('World', 'EU-27', 'Other Asia, nes', 'Other Europe, nes', 'Areas, nes')
world_data  <- world_data[!(world_data$partner %in% ignore) ,]
world_data  <- world_data[!(world_data$reporter %in% ignore) ,]
