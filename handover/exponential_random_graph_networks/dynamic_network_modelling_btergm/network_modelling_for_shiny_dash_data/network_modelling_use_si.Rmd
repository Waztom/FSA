...
#Prepare network objects as netowork graphs for each month of trade using COMTRADE data for modelling
```{r}
...
model.1c <- btergm(cucumber_net_list ~ edges + transitiveties + isolates + mutual + odegree1.5 + idegree1.5 + memory(type = "stability"), R = 100, parallel = "snow",  ncpus = 2)
...
#Save net_list
saveRDS(cucumber_net_list, "cucumber_net_list.rds")
```
