...
anomaly_plot <- plot_anomalies(anomaly_recomposed, time_recomposed = TRUE, ncol=3, color_no = "darkgreen", color_yes = "green", alpha_ribbon = 1) + ylim(c(1 ,-1 )) + labs(labs(x="Time", y="Consumer                                      Distributor                                      Producer")) + theme(axis.text=element_text(size=12),
