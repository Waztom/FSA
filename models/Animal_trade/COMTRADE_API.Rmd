...
ct_commodity_lookup("Haliotis",return_code = FALSE,return_char = FALSE,verbose = TRUE)
```
...
write.csv(tmp, "~/Projects/FSA/models/Animal_trade/animal_trade_paper/data/world.csv")
```
