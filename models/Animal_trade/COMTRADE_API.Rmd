...
ct_commodity_lookup("Rice",return_code = FALSE,return_char = FALSE,verbose = TRUE)
```
...
write.csv(mydf, "~/Projects/FSA/models/Animal_trade/animal_trade_paper/data/world.csv")
```
