...
ax.set_title('Pork importer network to United Kingdom')

#pos = nx.nx_agraph.graphviz_layout(G, prog='twopi')
#pos = nx.nx_agraph.graphviz_layout(G, prog='neato')
pos = nx.fruchterman_reingold_layout(G, weight=weights, scale=2)
...
#plt.colorbar()
plt.axis('off')
plt.savefig('pork_net_'+str(quantile)+'.pdf', dpi=600)
