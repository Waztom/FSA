...
#Access comtrade database - look for cucumber info for Spain
```{r}
source("/Users/Warren/Desktop/S2DS_FSA_Warren/get_Comtrade_data_network_graph.R")
