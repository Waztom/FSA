...
#Organise data into network objects for each month of trade
```{r}
world_data   <- read.csv("si_ms.csv", header = TRUE, sep = ",")
...
#Simple exponential random graph model with temperal component
...
#Save model
saveRDS(model.1c, "maple_syrup_model_si.rds")

#Save net_list
saveRDS(net_list, "maple_syrup_net_list.rds")
