...
model.1c <- btergm(net_list ~ edges + mutual + transitiveties, R = 50, parallel = "snow",  ncpus = 3)
...
model.1d <- btergm(net_list[1:23] ~ edges + mutual + transitiveties, R = 50, parallel = "snow",  ncpus = 2)
